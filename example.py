...
if __name__ == '__main__':
    ...
    packages = [{"type": "colis", "poids": 1, "longueur": 7, "largeur": 8, "hauteur":11, "value": 10.0, "description": "Newspapers"},
    ...
    _, quotation = api.get_quotation(from_, to, packages, additional_parameters)
    ...
    if optional_param:
        ...
        final_date_of_delivery = "28-07-2021" # Final date DD-MM-YYYY till package must be delivered.
    ...
    _, order = api.create_order(from_, to, packages, additional_parameters)
